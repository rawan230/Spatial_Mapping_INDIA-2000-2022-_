...
| 6 | **Step 7: retrained on corrected features + spatial-block CV added** (untuned baseline) | Random-split: RF 0.9687 (was 0.9683), MaxEnt 0.9594 (was 0.9595) — essentially unchanged despite losing top-3 features. **Spatial-block CV (new, matches CDR-PINN's Track B1 exactly): RF 0.9501±0.0031, MaxEnt 0.9455±0.0050 — both far above CDR-PINN's own 0.754.** | `Integrated_Analysis` repo, commit `16d093a` |
